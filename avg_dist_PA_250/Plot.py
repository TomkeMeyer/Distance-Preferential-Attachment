...
fig, ax = plt.subplots()
multi_results = []
for i,l in zip(['avg_dist_PA_t250_b0_', 'avg_dist_PA_t250_b0.25_', 'avg_dist_PA_t250_b0.5_', 'avg_dist_PA_t250_b0.75_', 'avg_dist_PA_t250_b1_', 'avg_dist_PA_t250_b2_'], range(6)):
    values = np.zeros(250)
    for j in range(10):
